...
// // MODELS
// import { LookUpItem } from '../../../models/base';
// import { Slide, SlideItem } from './model';
...
// // MOCKS
// import { AppEventsMock } from '../../../../mocks/core/providers/app-events/app-events';
// import { LoadingMock } from '../../../../mocks/core/providers/loading/loading';
// import { LoggerMock } from '../../../../mocks/core/providers/logger/logger';
// import { NavParamsMock } from '../../../../mocks/ionic/nav-params';

// // TESTING UTILITIES
// import { setUpTestBed } from '../../../../test-utils/test-common.spec';
...
//     let appEventsMock: AppEventsMock;
...
//         appEventsMock = new AppEventsMock();
...
//             ],
//             providers: [
//                 { provide: AppEvents, useValue: appEventsMock },
...
//                     });
//                 });
//                 it('should NOT set lookups', () => {
//                     comp.ionViewDidEnter();

//                     expect(comp.lookups).toBeNull();
//                 });
//                 it('should invoke logger.error with the right param', () => {
//                     comp.ionViewDidEnter();

//                     expect(loggerMock.error).toHaveBeenCalledWith('MultiLevelSelectDialogComponent: received empty lookups; Lookups: undefined');
//                 });
//                 it('should invoke appEvents.notifyGeneralError with the right param', () => {
//                     comp.ionViewDidEnter();

//                     expect(appEventsMock.notifyGeneralError).toHaveBeenCalledWith('Internal error: lookups is empty.');
//                 });
//             });
...
//                             })();
//                         });
//                         it('should invoke logger.error with the right param', (done) => {
//                             fakeAsync(() => {
//                                 comp.slideTo(itemOrIndexParam);
//                                 tick(delay);

//                                 expect(loggerMock.error).toHaveBeenCalledTimes(1);
//                                 expect(loggerMock.error).toHaveBeenCalledWith('MultiLevelSelectDialogComponent: itemOrIndex.nextSlideIndex must not be null', itemOrIndexParam);
//                                 done();
//                             })();
//                         });
//                     });
...
//                         expect(loggerMock.error).toHaveBeenCalledTimes(1);
//                         expect(loggerMock.error).toHaveBeenCalledWith('MultiLevelSelectDialogComponent: itemOrIndex must not be null', itemOrIndexParam);
//                         done();
//                     })();
//                 });
//             });
